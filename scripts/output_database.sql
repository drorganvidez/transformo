...
-- Tuesday, April 26, 2022 18:09:21
...
-- -----------------------------------------------------
-- Table  `output_database`.`borrar`
-- -----------------------------------------------------

DROP TABLE IF EXISTS `output_database`.`borrar` ;
CREATE TABLE IF NOT EXISTS `output_database`.`borrar` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(50)  NOT NULL,
  PRIMARY KEY (id))
ENGINE = InnoDB
...
INSERT INTO `output_database`.`borrar` 
